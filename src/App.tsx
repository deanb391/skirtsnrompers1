    ...
    <div className="min-h-screen bg-surface selection:bg-primary-container-brand selection:text-white pb-0 relative overflow-x-hidden font-bevietnam">
      ...
      <nav className="fixed top-4 left-4 right-4 z-40 flex justify-between items-center px-6 md:px-8 py-3.5 max-w-7xl mx-auto rounded-full bg-surface-container-lowest/90 backdrop-blur-md shadow-xs border border-surface-dim/40">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={() => window.open("https://wa.me/2349076596980?text=Hello!%20I'd%20like%20to%20consult%20from%20Skirts%20'n'%20Rompers!%20🌸", "_blank")}
  ...
  />
              ...
              >
                ...
                <div className="pt-4 flex-1 flex flex-col justify-between">
                  ...
                  <div className="pt-4 mt-2">
                    <button
                      onClick={() => window.open(`https://wa.me/2349076596980?text=Hello!%20I'd%20like%20to%20inquire%20about%20the%20${encodeURIComponent(p.name)}!%20🌸`, "_blank")}
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
          ...
          <div className="w-full lg:w-1/2 space-y-8 text-left">
            ...
            <div className="pt-2 flex flex-col sm:flex-row gap-3">
              ...
              <button
                onClick={() => window.open(`https://wa.me/2349076596980?text=Hello%20Skirts%20'n'%20Rompers!%20I%20am%20interested%20in%20obtaining%20a%20personal%20clothing%20capsule%20style:%20${activePersonaDetail.title}!`, "_blank")}
      ...
      <footer id="contact" className="bg-surface-container dark:bg-inverse-surface w-full px-6 py-16 flex flex-col md:flex-row justify-between items-start gap-10 rounded-t-[3rem] mt-24">
        ...
        <div className="flex flex-col gap-3 text-left">
          ...
          <button
            onClick={() => window.open("https://wa.me/2349076596980?text=Hello%20Skirts%20'n'%20Rompers!%20I%20have%20a%20question%20regarding%20my%20order%20status.🌸", "_blank")}
